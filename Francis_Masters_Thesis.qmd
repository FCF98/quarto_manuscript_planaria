...
f_value <- anova_results["Condition", "F value"]
p_value <- anova_results["Condition", "Pr(>F)"]
...
The ANOVA results indicate that the effect of `Condition` on `Distance` is not statistically significant (F = `r f_value`, p = `r p_value`).
