...
@fig-Exp2-decisions-line shows the average percentage of trials where subjects entered the active arm across the four time points. A generalised linear model with family set to binomial was fitted in R. Subject ID was set as a random effect, with condition, time point and the interaction term as a fixed effects. Pairwise comparisons with a Bonferroni correction were carried out using the emmeans package in R. A type 3 ANOVA
